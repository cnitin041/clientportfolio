...
import { getHoudiniToolBySlug } from 'features/tools/data/houdini';
...
const HoudiniToolDetail = () => {
  const { slug } = useParams();
  const tool = getHoudiniToolBySlug(slug);
    ...
    return (
      <Page>
        <Container>
          ...
          <BackLink to="/tools/houdini">← Back to Houdini Tools</BackLink>
        </Container>
      </Page>
    );
  }
...
export default HoudiniToolDetail;
